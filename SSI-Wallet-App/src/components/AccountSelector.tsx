...
interface AccountSelectorProps {
  ...
  setCredentials: React.Dispatch<React.SetStateAction<VerifiableCredential[]>>;
}

const AccountSelector: React.FC<AccountSelectorProps> = ({ keys, selectedKey, setSelectedKey , setCredentials}) => {
  const handleAccountSelection = (key: ManagedKeyInfo) => {
    ...
    console.log('Changed account to: ', key);
     ...
     const account = key.meta?.account.address;
