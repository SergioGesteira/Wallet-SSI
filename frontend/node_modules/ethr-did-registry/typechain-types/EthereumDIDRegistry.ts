...
export interface EthereumDIDRegistryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string
  encodeFunctionData(
...
export type DIDAttributeChangedEventFilter = TypedEventFilter<DIDAttributeChangedEvent>
...
export type DIDDelegateChangedEventFilter = TypedEventFilter<DIDDelegateChangedEvent>
...
export type DIDOwnerChangedEvent = TypedEvent<[string, string, BigNumber], DIDOwnerChangedEventObject>
