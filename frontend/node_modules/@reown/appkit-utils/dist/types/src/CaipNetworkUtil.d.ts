...
export declare const CaipNetworksUtil: {
    ...
    getCaipNetworkId(network: AppKitNetwork): `eip155:${string}` | `eip155:${number}` | `solana:${string}` | `solana:${number}` | `polkadot:${string}` | `polkadot:${number}`;
    getRpcUrl(caipNetwork: AppKitNetwork, caipNetworkId: CaipNetworkId, projectId: string): string;
    extendCaipNetwork(caipNetwork: AppKitNetwork, { customNetworkImageUrls, projectId }: ExtendCaipNetworkParams): CaipNetwork;
    extendCaipNetworks(caipNetworks: AppKitNetwork[], { customNetworkImageUrls, projectId }: ExtendCaipNetworkParams): [CaipNetwork, ...CaipNetwork[]];
};
export {};
