...
import { ManagedKeyInfo , DIDResolutionResult, DIDDocument, VerifiableCredential, VerifiablePresentation} from '@veramo/core';
  ...
  const handleReject = async (did: string) => {
    ...
    const handleSendCredential = async () => {
      ...
      try {
        ...
        console.log('Sending verifiable credential:', credentialString);
        await axios.post('http://localhost:5000/university/sendVerifiableCredential', { verifiableCredential: credentialString });
